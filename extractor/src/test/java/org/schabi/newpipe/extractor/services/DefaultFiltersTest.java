...
public abstract class DefaultFiltersTest {
    ...
    @Test
    void noSortFilterItemShouldBeNull() {
     ...
     */
    @Test
    void validContentFilterAndSortFiltersTest() {
     ...
     */
    @Test
    void validContentFilterWithAllSortFiltersTest() {
